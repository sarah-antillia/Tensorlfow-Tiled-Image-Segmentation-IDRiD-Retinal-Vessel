...
class ImageMaskDatasetGenerator:
  ...
  def create_mask_files(self, mask_file, index):
    ...
    if self.augmentation:
        # augment(self, image, basename, output_dir, border=(0, 0, 0), mask=False):
...
if __name__ == "__main__":
  try:
    input_images_dir = "./IDRiD-master/images/"
    input_masks_dir  = "./IDRiD-master/masks/"

    output_images_dir = "./Augmented-IDRiD-master/images/"
    output_masks_dir  = "./Augmented-IDRiD-master/masks/"
