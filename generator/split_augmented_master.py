...
# split_augmented_mester.py
# 2025/03/08 sarah@antillia.com
...
if __name__ == "__main__":
  try:
    images_dir = "./Augmented-IDRiD-master/images/"
    masks_dir  = "./Augmented-IDRiD-master/masks/"
    output_dir = "../dataset/Augmented-IDRiD/"
